    ...
    <Page>
      <div className="interests">
        <div className="description pageText">
          ...
          I enjoy football games, in particular games featuring my beloved Arsenal.
          I also read Hacker News and keep up with current affairs, and occasionally end up
